...
- Parameter classes: `docs/architecture/addendum-asyncpg-database-pattern.md` (Sezione 7)
- **PostgreSQL Pagination**: `docs/tech-reference/05-postgresql-pagination.md` — Pattern LIMIT/OFFSET vs Keyset pagination, trade-offs performance, backend/frontend integration
